...
const closeAddNoteModal = document.getElementById('note-close-button')
const saveNoteButton = document.getElementById('note-save-add-button')
const missingTitleError = document.getElementById('note-missing-title-error')
...
const missingTitleEditError = document.getElementById('note-missing-title-edit-error')
